  ...
  <div class="row">
    <div class="col-md-4 offset-md-4">
      <div class="card card-login">
        <div class="card-header">Login 2</div>
        <div class="card-body">
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?page=login2"; ?>" method="post">
            <div class="form-group">
              <input class="form-control <?php echo (!empty($login["user_msg"])) ? 'is-invalid' : ''; ?> "
            ...
            <div class="form-group">
              <input class="form-control <?php echo (!empty($login["pass_msg"])) ? 'is-invalid' : ''; ?>" id="password"
